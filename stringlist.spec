...
%description -l pl 
Biblioteka StringList umoøliwia rÛønorodne ustawienia funkcji
konfiguracyjnych dla Enlightenmenta.

%package devel
Summary:	Header files and other resources for development
Summary(pl):	Pliki nag≥Ûwkowe i inne zasoby potrzebne
...
Pliki nagÛ≥wkowe i inne zasoby potrzebne przy robieniu aplikacji
wykorzystujacych bibliotekÍ stringlist.
